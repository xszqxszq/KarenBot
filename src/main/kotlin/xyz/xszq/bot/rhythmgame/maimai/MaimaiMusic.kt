...
import xyz.xszq.bot.rhythmgame.maimai.MaimaiUtils.calcB50Change
import xyz.xszq.bot.rhythmgame.maimai.MaimaiUtils.difficulty2Name
...
import xyz.xszq.bot.rhythmgame.maimai.MaimaiUtils.remasterExcluded
import xyz.xszq.bot.rhythmgame.maimai.payload.*
import xyz.xszq.nereides.message.Markdown

class MaimaiMusic(val logger: KLogger) {
