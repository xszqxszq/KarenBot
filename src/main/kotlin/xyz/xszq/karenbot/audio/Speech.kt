...
import xyz.xszq.karenbot.CommonCommandWithArgs
import xyz.xszq.karenbot.Cooldown
import xyz.xszq.karenbot.ffmpeg.FFMpegFileType
import xyz.xszq.karenbot.ffmpeg.FFMpegTask
import xyz.xszq.karenbot.ifReady
import xyz.xszq.karenbot.kotlin.toFile
import xyz.xszq.karenbot.kotlin.toPinyinList
...
object Speech: CommandModule("语音功能", "speech") {
    ...
    private val voiceDir = KarenBot.configFolder.resolve("audio/otto").toVfs()
