...
object CooldownConfig: SafeYamlConfig<MapValues>(KarenBot, "cooldown", MapValues(buildMap {
    put("accept", 1000L)
}.toMutableMap()))
object QuotaConfig: SafeYamlConfig<MapValues>(KarenBot, "quota", MapValues(buildMap {
