...
import xyz.xszq.karenbot.*
import xyz.xszq.karenbot.audio.AudioEncodeUtils
import xyz.xszq.karenbot.audio.getAudioDuration
import xyz.xszq.karenbot.kotlin.toArgsList
import xyz.xszq.karenbot.kotlin.toFile
import xyz.xszq.karenbot.mirai.equalsTo
...
object RandomHandler: CommandModule("随机功能", "random") {
    ...
    fun fetchRandom(type: String): File = KarenBot.configFolder.resolve("music/$type").listFiles()!!
