...
class ImageController(
    ...
    companion object {
        ...
        val courseAliases = buildMap {
            put(552201, listOf("随机红初级", "随机expert初级", "红初级"))
            put(552202, listOf("随机红中级", "随机expert中级", "红中级"))
            put(552203, listOf("随机红上级", "随机expert上级", "红上级"))
            put(552204, listOf("随机红超上级", "随机红超上", "随机expert超上级", "红超上级", "红超上"))
            put(552301, listOf("随机紫初级", "随机初级", "随机master初级", "紫初级", "初级"))
            put(552302, listOf("随机紫中级", "随机中级", "随机master中级", "紫中级", "中级"))
            put(552303, listOf("随机紫上级", "随机上级", "随机master上级", "紫上级", "上级"))
            put(552304, listOf("随机紫超上级", "随机紫超上", "随机超上级", "随机超上", "随机master超上级", "紫超上级", "紫超上", "超上"))
        }
